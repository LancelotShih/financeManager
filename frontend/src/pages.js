          ...
          {accounts.length === 0 ? (
            ...
            <ul style={{paddingLeft: 0, listStyle: 'none'}}>
              {accounts.map(acc => {
                ...
                return (
                  <li key={acc.name} style={{marginBottom: 12, border: '1px solid #eee', borderRadius: 8, background: '#fafbfc'}}>
                    ...
                    {isOpen && (
                      <div style={{padding: '16px 16px 8px 16px', borderTop: '1px solid #eee'}}>
                        <div style={{marginBottom: 12}}>
                          ...
                          <input
                            ...
                            style={{width: '100%', padding: 8, fontSize: 15, borderRadius: 5, border: '1px solid #ccc'}}
                          />
                        </div>
                        <div style={{marginBottom: 12}}>
